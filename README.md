...
**Task-System** is a high-performance, modular web application built with **ASP.NET Core** for managing tasks, projects, teams, and user activities. It integrates JWT authentication, PostgreSQL database, Serilog logging, and supports extensible REST APIs with **Swagger/OpenAPI** documentation.
