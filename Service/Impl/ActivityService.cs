...
public class ActivityService : IActivityService
{
    ...
    {
        l.log($"Creating ActivityPropertyUpdated: Type={Type}, OldValue={OldValue}, NewValue={NewValue}, issueId={issueId}");
    ...
    {
        l.log($"Creating ActivityPropertyCreated: Type={Type}, issueId={issueId}");
