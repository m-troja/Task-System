...
namespace Task_System.Migrations
{
    ...
    [Migration("20260221135658_Attachment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Task_System.Model.Entity.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Task_System.Model.IssueFolder.CommentAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_comment_attachment");

                    b.HasIndex("CommentId")
                        .HasDatabaseName("ix_comment_attachment_comment_id");

                    b.ToTable("comment_attachment", "public");
                });
            ...
            modelBuilder.Entity("Task_System.Model.IssueFolder.ActivityPropertyCreated", b =>
                {
            ...
            modelBuilder.Entity("Task_System.Model.Entity.RefreshToken", b =>
                {
                    b.HasOne("Task_System.Model.Entity.User", "User")
            ...
            modelBuilder.Entity("Task_System.Model.IssueFolder.CommentAttachment", b =>
                {
                    b.HasOne("Task_System.Model.IssueFolder.Comment", "Comment")
                        .WithMany("attachments")
                        .HasForeignKey("CommentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_comment_attachment_comments_comment_id");
