...
try
{
    Log.Information("Starting Task_System WebApplication...");
    ...
    {
        var dbName = Environment.GetEnvironmentVariable("TS_DB_NAME") ?? "Task_System";
    ...
    Log.Information($"Task_System WebApplication started successfully on port {_HttpPort}");
